	...
	//페이지번호와 페이지블럭 이미지를 같이 출력
			...
			*/
			...
			if(intTemp != 1) {
				...
				pagingStr += ""
					...
					+ "<img src='../common/images/paging1.gif'></a>";
				pagingStr += "&nbsp;";
				pagingStr += ""
					+ "<a href='"+page+"nowPage="+
									(intTemp-blockPage)+"'>"
					+ "<img src='../common/images/paging2.gif'></a>";
			}
			...
			*/
			...
			if(intTemp <= totalPage) {
				pagingStr += "<a href='"+page+"nowPage="+
												intTemp+"'>"
					+ "<img src='../common/images/paging3.gif'></a>";
				pagingStr += "&nbsp;";
				pagingStr += "<a href='"+page+"nowPage="+
												totalPage+"'>"
					+ "<img src='../common/images/paging4.gif'></a>";
			}		
		...
		public static String pagingImgServlet(
			...
			*/
			...
			//5.다음페이지블럭 & 마지막페이지 바로가기
			if(intTemp <= totalPage) {
				pagingStr += "<li><a href='"+page+"nowPage="+
												intTemp+"'>"
