...
@WebServlet("/01Main/AcaMembersList.do")
public class AcaMembersListCtrl extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int pageSize = Integer.parseInt(
	 	...
	 	List<MembersDTO> lists = dao.selectPaging2(param);
	 	
	 	String pagingImg = util.PagingUtil.pagingImgServlet(
				totalRecordCount,pageSize,
				blockPage, nowPage,
				"../01Main/AcaMembersList.do?"+addQueryString);
	 	//자원해제
	 	dao.close();
		...
		RequestDispatcher dis =
				req.getRequestDispatcher("/01Main/AcaMembersList.jsp");
