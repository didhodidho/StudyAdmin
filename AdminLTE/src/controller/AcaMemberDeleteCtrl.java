...
@WebServlet("/01Main/AcaMembersDelete.do")
public class AcaMemberDeleteCtrl extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("../01Main/AcaMembersList.do").forward(req, resp);
	}
